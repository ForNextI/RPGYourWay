...
export function ShapeSignInGate() {
  ...
  return (
    <section className="shape-gate" aria-labelledby="shape-sign-in-title">
      ...
      <h2 id="shape-sign-in-title">Sign in before you hand Shape a campaign.</h2>
      <p>Your Shape jobs belong to your account so a long conversion can survive a refresh, a closed tab, or a temporary processing failure.</p>

...
has(foundryCombatHandoff, 'version: 3,', 'Foundry encounter payload v3')
...
has(css, '.start-rules-current--display[aria-expanded="true"] .start-rules-accordion-plus,', 'black rotating Start system screw')
has(css, '.start-character-actions--secondary .start-forest-control {', 'forest character-resource actions')
has(css, '.start-rtp-presets > button small {', 'Ready-to-Play preset explanation styling')
...
has(landing300, 'landing-accordion unique-accordion\">', 'Why-created default-closed accordion')
has(landing300, 'landing-accordion audience-accordion\">', 'Audience default-closed accordion')
lacks(landing300, 'landing-accordion unique-accordion\" open', 'Why-created must not default open')
lacks(landing300, 'landing-accordion audience-accordion\" open', 'Audience must not default open')
has(landing300, '<NestedAccordionList items={whyCreated} />', 'Why-created nested default-closed accordions')
has(landing300, '<NestedAccordionList items={audiences} />', 'Audience nested default-closed accordions')
lacks(landing300, '<NestedAccordionList items={whyCreated} initiallyOpen />', 'Why-created nested accordions must not default open')
lacks(landing300, '<NestedAccordionList items={audiences} initiallyOpen />', 'Audience nested accordions must not default open')

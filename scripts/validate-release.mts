...
assert.match(start180, /Give your campaign a fun name/)
...
assert.match(css180, /RPG Your Way 1\.8\.1 — compact Start controls, olive onboarding surfaces, and restored house lime/)
assert.match(css180, /\.start-rules-toggle/)
assert.match(css180, /\.start-top-help/)
assert.match(css180, /\.start-step-nameplate/)
assert.match(css180, /\.start-leader-explain:hover/)
assert.match(start180, /aria-expanded={rulesOpen}/)
assert.match(start180, /Current default/)
assert.match(start180, /Change age settings/)
assert.doesNotMatch(start180, /Another system/)
console.log('RPG Your Way 1.8.1 Start toolbar, five-rules accordion, olive surfaces, and restored house-lime checks passed.')

assert.match(start180, /start-step-nameplate start-step-nameplate--rules"><span>1</)
assert.match(start180, /<span>2<\/span>Default party/)
assert.match(start180, /<span>3<\/span>Customize or Default Settings/)
...
assert.match(css180, /RPG Your Way 1\.8\.2/)
console.log('RPG Your Way 1.8.2 Start QA labels, compact-question layout, naming copy, and fixed default-voice checks passed.')


assert.match(start180, /start-step-nameplate start-step-nameplate--rules/)
assert.match(start180, /start-rules-current/)

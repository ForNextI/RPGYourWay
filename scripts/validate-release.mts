...
assert.equal(pkg.rpgywVersion, '1.8.2')
assert.match(read('lib/version.ts'), /APP_VERSION = '1\.8\.2'/)
...
assert.match(start180, /D&D 5\.5e.*Default/)
...
assert.match(start180, /start-rules-number">1</)

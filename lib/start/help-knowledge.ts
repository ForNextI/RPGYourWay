export const START_FAQ = [
  ...
  ['How do I add my own character?', 'Add a PDF, JSON, XML, TXT, or Markdown record by browsing or dragging it onto the Browse control, or paste the character information. Then choose Import into RPG Your Way on that character.'],
  ...
  ['Can I change a character name or portrait later?', 'Yes. Names and portraits can be changed later on the Play page through the Characters sidebar. Click on whoever you want to edit.'],
...
The onboarding flow is: choose game rules; gather a party; import custom characters one at a time if needed; accept/change/remove the proposed party leader; customize or use default gameplay settings; name the campaign and Game Master; continue to Play.
...
Names and portraits can be changed later on the Play page through the Characters sidebar by clicking the character to edit. Portraits are not imported on Start.

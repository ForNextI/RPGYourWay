    ...
    <PageShell>
      <main id="main-content" tabIndex={-1} className="inner-main">
        <div className="shell narrow-shell">
          ...
          <p className="page-lede">This route is reserved for the commercial AIGM experience. The next build will begin bringing over the proven WardensPC gameplay systems without dragging the rest of the old site along with them.</p>
